...
import { useLecturerAccountCreate } from './hook'
import { FormLecturerAccount } from './form-lectureraccount'
import { ConfirmCloseModal } from '@/components/common/confirm-close-modal'
interface CreateLecturerAccount {
  isOpen: boolean
  closeModal: () => void
}
const CreateLecturerAccountModal = (props: CreateLecturerAccount) => {
  const { handleFormSubmit, formCreate, mutation } = useLecturerAccountCreate(
    props.closeModal
  )
...
export default CreateLecturerAccountModal
