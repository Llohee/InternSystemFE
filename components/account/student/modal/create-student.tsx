...
import { useStudentAccountCreate } from './hook'
...
const CreateStudentAccountModal = (props: CreateStudentAccount) => {
  const { handleFormSubmit, formCreate, mutation } = useStudentAccountCreate(
    props.closeModal
  )
