...
export const CVListViewSkeleton = () => {
  return (
    <>
      <div className="w-full h-full bg-white border-grey-3 p-5 overflow-hidden">
        <div className="  grid md:grid-cols-12 ">
          <div className="col-span-8 px-2 flex flex-col gap-2">
              <div className="flex justify-between items-center">
                <div className=" animate-pulse bg-grey-5 h-6 w-20" />
                <div className=" animate-pulse bg-grey-5 h-8 w-28 rounded-md" />
              </div>
              {/* <div className="flex items-center gap-2 py-3">
                <div className="grow flex flex-col gap-1">
                  <div className="animate-pulse bg-grey-5 h-5" />
              ...
              <div className="animate-pulse bg-grey-5 h-20 w-full"></div>
          </div>
