...
import FormSemester from './form-semester'
import { useSemesterCreate } from './hook'
import { SchoolYearDetail, SemesterDetail } from '@/models/api'

const CreateSemesteModal = (props: {
  isOpen: boolean
  closeModal: () => void
      ...
      <Modal
        ...
        title={
          <div className="w-full h-6 flex gap-3 items-center">
            <div className="grow">Tạo mới kì học</div>
            <Button
              iconOnly
...
export default CreateSemesteModal
