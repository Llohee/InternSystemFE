...
import { useSchoolYearUpdate } from './hook'
import FormSchoolYear from './form-school-year'
import { SchoolYearDetail } from '@/models/api'

const UpdateSchoolYearModal = (props: {
  isOpen: boolean
  closeModal: () => void
  ...
  const { updateSchoolYear, handleFormSubmit, mutation } = useSchoolYearUpdate(
    props.closeModal,
    props.schoolyearDetail
  )
  return (
    <>
      <Modal
