...
import { useCustomPostCreate } from './hook'
import { ConfirmCloseModal } from '@/components/common/confirm-close-modal'
import FormCustomPost from './form-custom-post'

const CreateCustomPostModal = (props: {
  isOpen: boolean
  closeModal: () => void
}) => {
  const { handleFormSubmit, formCreate, mutation } = useCustomPostCreate(
    props.closeModal
  )
...
export default CreateCustomPostModal
